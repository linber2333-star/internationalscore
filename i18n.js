...
window.I18N = {
  'zh-CN': {
    ...
    'deep.notice.title': '深度测试 · 开发中', 'deep.notice.text': '我们的深度测试题库仍在开发中，大部分题目尚未导入和更新。但它已经与快速版测试略有不同。感谢你的理解。', 'deep.notice.ok': '好的，开始测试', 'deep.notice.cancel': '暂不测试',
    ...
    'quiz.prev': '上一页', 'quiz.next': '下一页', 'quiz.submit': '查看结果', 'quiz.gotoUnanswered': '返回未答题',
    'quiz.skip': '跳过（不适用）',
  ...
  'zh-TW': {
    ...
    'deep.notice.title': '深度測試 · 開發中', 'deep.notice.text': '我們的深度測試題庫仍在開發中，大部分題目尚未導入和更新。但它已經與快速版測試略有不同。感謝你的理解。', 'deep.notice.ok': '好的，開始測試', 'deep.notice.cancel': '暫不測試',
    ...
    'quiz.prev': '上一頁', 'quiz.next': '下一頁', 'quiz.submit': '查看結果', 'quiz.gotoUnanswered': '返回未答題',
    'quiz.skip': '跳過（不適用）',
