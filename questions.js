...
(function () {
  ...
  window.QUESTION_BANK = [
    ...
    { /* QK5f — Weight Female */
      ...
      options: [
        { cn: '45kg 以下',        tw: '45kg 以下',        score: 0 },
        { cn: '45 - 55kg',        tw: '45 - 55kg',        score: 0 },
        { cn: '55 - 65kg',        tw: '55 - 65kg',        score: 0 },
        { cn: '65 - 80kg',        tw: '65 - 80kg',        score: 0 },
        { cn: '80kg 以上',        tw: '80kg 以上',        score: 0 },
      ],
    },
    ...
    { /* QKC3 — Bad habits (multi-select) */
      ...
      options: [
        ...
        { cn: '长期吸烟。',                                     tw: '長期吸菸。',                                     score: 0, negative: true },
        { cn: '长期饮酒。',                                     tw: '長期飲酒。',                                     score: 0, negative: true },
    ...
    { /* QKC4 — Vision */
      ...
      options: [
        { cn: '视力完好。',                     tw: '視力完好。',                     score: 0 },
        { cn: '轻度近视/散光。',                 tw: '輕度近視/散光。',                 score: 0 },
        { cn: '重度近视/散光。',                 tw: '重度近視/散光。',                 score: 0 },
        { cn: '视力明显受损。',                 tw: '視力明顯受損。',                 score: 0 },
        { cn: '法定失明或接近完全失明。',         tw: '法定失明或接近完全失明。',         score: 0 },
      ],
    },
    ...
    { /* QKB7 — Social circle rescue capability (moved from bonus) */
      ...
      tw: '你社交圈的「硬核救援能力」如何？',
      options: [
        { cn: '如果明天需要一大笔应急资金，我能很快从可信的人际关系中借到。', tw: '如果明天需要一大筆應急資金，我能很快從可信的人際關係中借到。', score: 4 },
